...
1. Add the [Net.RunMethodsSequentially](https://www.nuget.org/packages/Net.RunMethodsSequentially) NuGet package to your main application, typically an ASP.NET Core project
